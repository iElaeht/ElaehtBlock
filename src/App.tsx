      ...
      {showMenu && (
        <div className="fixed inset-0 bg-black/95 z-[200] flex items-center justify-center p-8 backdrop-blur-2xl">
          <div className="w-full max-w-[280px] flex flex-col space-y-3">
            ...
            <div className="pt-2">
              {!confirmDelete ? (
                <button onClick={() => setConfirmDelete(true)} className="w-full py-4 bg-red-600/10 border border-red-600/20 rounded-2xl text-red-500 font-black text-[9px] tracking-widest uppercase">
                  Borrar Récord
                </button>
              ) : (
